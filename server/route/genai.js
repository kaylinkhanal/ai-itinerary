...
const ai = new GoogleGenAI({ 
  apiKey: "AIzaSyArP0OmPSHc67m-ytnC0IEISfLYBP17hAM"
});
...
We as a system have partnerships with only following hotels in Pokhara, Nepal: ${hotels.map(hotel => hotel.name).join(', ')}. Please suggest only from these hotels for accommodation and daily hotel suggestions in the itinerary.
